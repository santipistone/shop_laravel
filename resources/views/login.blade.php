...
<input required="" class="input-box2" name="email" placeholder="Username">
<input required="" type="password" name="passw" id="change-id" class="input-box2" placeholder="Password">
